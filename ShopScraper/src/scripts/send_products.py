...
def read_products_from_csv(store_name: str) -> List[product_pb2.Product]:
...
def send_products_to_grpc(products: List[product_pb2.Product]):
    ...
    for i in range(0, len(products), BATCH_SIZE):
        ...
        try:
            ...
            print(f"[INFO] Sent batch {i//BATCH_SIZE + 1}: success = {response.success}")
