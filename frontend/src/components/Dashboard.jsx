            ...
            <div className={`lg:w-2/3 ${activeTab !== "products" ? "hidden lg:block" : ""}`}>
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-8">
                ...
                <div className="p-6">
                  ...
                  {cheapest && (
                    <div className="mb-6 border-l-4 border-green-500 bg-green-50 rounded-lg p-5 shadow-sm">
                      <div className="flex gap-4 mb-4">
                        ...
                        <div className="flex-1">
                          <h3 className="font-bold text-lg text-gray-800 mb-1">Best Price Found:</h3>
                        ...
                        <button
                          ...
                          className="bg-green-600 text-white h-10 w-10 rounded-full hover:bg-green-700 transition flex items-center justify-center shadow-md self-start"
                        >
                          <Plus size={20} />
                        </button>
                      </div>
                      <p className="text-sm text-gray-600 mb-3">{cheapest.description}</p>
                      <div className="flex items-baseline gap-3 mb-3">
                        <p className="text-xl font-bold text-green-600">{cheapest.price} €</p>
                      ...
                      <button
                        ...
                        className="bg-gray-800 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition text-sm shadow-sm flex items-center gap-1"
                      >
                        <Filter size={16} />
                        Show all options
                      </button>
                        ...
                        >
                          <div className="flex gap-4">
                            ...
                            <button
                              ...
                              className="bg-green-600 text-white h-9 w-9 rounded-full hover:bg-green-700 transition flex items-center justify-center shadow-sm self-start"
                            >
                              <Plus size={18} />
                            </button>
                          </div>
                    ...
                    <div>
                      <ul className="space-y-3 mb-6">
                        {shoppingList.map((item, index) => (
                          <li key={index} className="border border-gray-200 p-3 rounded-lg hover:bg-gray-50 transition">
                            <div className="flex gap-3">
                              ...
                              <button
                                ...
                                className="text-red-600 hover:text-red-800 hover:bg-red-50 rounded-full h-8 w-8 flex items-center justify-center transition flex-shrink-0"
                              >
                                <X size={18} />
                              </button>
                            </div>
